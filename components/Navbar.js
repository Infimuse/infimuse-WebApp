  ...
  return (
    <header className="sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md p-5 md:px-20">
      ...
      <div className="flex items-center justify-end space-x-4 text-gray-500">
        <Link href="/communities" class=" flex gap-1 bg-rainbow-gradient p-2 cursor-pointer rounded-md text-white font-semibold">
        <FaSearch className="h-6 cursor-pointer" />
          Communities
        </Link>
        <Link href="/pricing" className="hidden md:inline cursor-pointer  p-2 rounded-md hover:bg-[#BB2460] hover:text-white text-black">Become a host</Link>
