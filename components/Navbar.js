    ...
    return (
        <header className="sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md p-5 md:px-10">
            ...
            <div className="flex items-center justify-end space-x-4 text-gray-500">
                ...
                <div className="flex items-center space-x-2 border-2 p-2 rounded-full" onClick={() => setShowDropdown(!showDropdown)}>
            ...
            {showDropdown && <SignIn onClose={() => setShowDropdown(false)} />}
            {showDropdown && <SignUp onClose={() => setShowDropdown(false)} />}
            <ToastContainer />
        </header>
    );
}
