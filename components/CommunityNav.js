  ...
  return (
    <header className="sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md p-5 md:px-20">
      ...
      <div className="flex items-center justify-end space-x-4 text-gray-500">
        ...
        <Link href="/pricing" className="hidden md:inline cursor-pointer  p-2 rounded-full bg-[#BB2460] hover:bg-gray-100 hover:text-[#BB2460] text-black">Become a host</Link>
