  ...
  return (
    <section className="bg-white ">
      <div className="container px-4 sm:px-6 lg:px-20 mx-auto">
        <div className="flex flex-col items-center text-center sm:flex-row mt-5 sm:text-left sm:justify-between">
          <div>
            <h2 className="text-2xl font-bold text-black sm:text-3xl ">Simple, transparent pricing</h2>
            ...
            <div className="overflow-hidden p-0.5 mt-6 border rounded-lg ">
                <div className="sm:-mx-0.5 flex">
                    <button className=" focus:outline-none px-3 w-1/2 sm:w-auto py-1 sm:mx-0.5 text-white bg-[#BB2460] rounded-lg">Monthly</button>
                    <button className=" focus:outline-none px-3 w-1/2 sm:w-auto py-1 sm:mx-0.5 text-gray-800  bg-transparent rounded-lg hover:bg-[#18BDFA]">Yearly</button>
                </div>
            </div>
        </div>

        <div className=" gap-6 mt-16  items-center flex justify-center mb-20 sm:gap-8 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            <div className="px-6 py-4 transition-colors duration-300 transform rounded-lg hover:bg-[#7fbfd6] ">
                <p className="text-lg font-medium text-gray-800  ">Intro</p>

                <h4 className="mt-2 text-3xl font-semibold text-gray-800  ">$19 <span className="text-base font-normal text-gray-600 ">/ Month</span></h4>
                
                <p className="mt-4 text-gray-500  ">For most businesses that want to optimaize web queries.</p>

                <div className="mt-8 space-y-8">
                    <div className="flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-[#BB2460]" viewBox="0 0 20 20" fill="currentColor">
                ...
                <button className="w-full px-4 py-2 mt-10 font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-gtahidiPink rounded-md hover:bg-gray-200">
                    Choose plan
                </button>
            </div>
            ...
            <div className="px-6 py-4 transition-colors duration-300 transform rounded-lg hover:bg-gray-200 ">
                ...
                <h4 className="mt-2 text-3xl font-semibold text-gray-800  ">$39 <span className="text-base font-normal text-gray-600 ">/ Month</span></h4>
                ...
                <button className="w-full px-4 py-2 mt-10 font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-gtahidiPink rounded-md hover:bg-gray-500">
                    Choose plan
                </button>
            </div>

            <div className="px-6 py-4 transition-colors duration-300 transform bg-gray-200 rounded-lg ">
                ...
                <button className="w-full px-4 py-2 mt-10 font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-gtahidiPink rounded-md hover:bg-gray-500 focus:outline-none focus:bg-blue-600">
                    Choose plan
                </button>
            </div>    
            <hr/>        
